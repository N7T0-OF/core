...
class YouTube {
    ...
    /** Published releases in GitHub's newest-first order, including prereleases. */
    suspend fun checkForGithubReleaseUpdates(): Result<List<GithubResponse>> =
        runCatching {
            ytMusic.checkForGithubReleaseUpdates().body<List<GithubResponse>>()
        }
